...
WEB_DIR=$BASE_DIR/tracer-pinpoint-web

CONF_DIR=$BASE_DIR/tracer-pinpoint-web/src/main/resources
...
KEY_VERSION="version"
KEY_CONTEXT_PATH="web.context.path"
KEY_PORT="web.port"
