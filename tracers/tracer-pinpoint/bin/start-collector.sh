...
COLLECTOR_DIR=$BASE_DIR/tracer-pinpoint-collector

CONF_DIR=$BASE_DIR/tracer-pinpoint-collector/src/main/resources
...
COLLECTOR_IDENTIFIER=pinpoint-collector
...
KEY_VERSION="version"
KEY_CONTEXT_PATH="collector.context.path"
KEY_PORT="collector.port"
