...
public class BetaService$FinagleService extends com.twitter.finagle.Service<byte[], byte[]> {
  final private BetaService.FutureIface iface;
  final private TProtocolFactory protocolFactory;

  public BetaService$FinagleService(final BetaService.FutureIface iface, final TProtocolFactory protocolFactory) {
    this.iface = iface;
